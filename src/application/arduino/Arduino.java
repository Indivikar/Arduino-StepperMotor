...
public class Arduino {
	...
	public Arduino(String portDescription, int baud_rate, MainWindowController mainWindowController) {
...
//			   out += (in.next()+"\n");			   
			   mainWindowController.getArduinoInputReader().action(in.next());
		   }
		   	in.close();
